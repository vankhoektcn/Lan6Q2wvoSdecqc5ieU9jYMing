if (typeof ketnoimoi == 'undefined')
	var ketnoimoi = {};
if (typeof ketnoimoi.projectcategories == 'undefined')
	ketnoimoi.projectcategories = {};

ketnoimoi.projectcategories.index = {
	table: null,
	commonControls: [
	{
	...
	},
	{
		'label': 'Đối tượng cha',
		'id': 'parent_id',
		'name': 'ProjectCategory[parent_id]',
		'type': 'select',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Hình ảnh',
		'id': 'attachments',
		'name': 'ProjectCategory[attachments]',
		'type': 'inputimages',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Xuất bản',
		'id': 'published',
		'name': 'ProjectCategory[published]',
		'type': 'checkbox',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	languageControls: [
	{
		'label': 'Tên đối tượng',
		'id': 'name',
		'name': 'ProjectCategory[ProjectCategoryTranslation][locale][name]',
		'type': 'text',
		'required': true,
	...
	},
	{
		...
		'id': 'summary',
		'name': 'ProjectCategory[ProjectCategoryTranslation][locale][summary]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		...
		'id': 'meta_description',
		'name': 'ProjectCategory[ProjectCategoryTranslation][locale][meta_description]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Meta Keywords',
		'id': 'meta_keywords',
		'name': 'ProjectCategory[ProjectCategoryTranslation][locale][meta_keywords]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	init: function () {
		var thisObj = ketnoimoi.projectcategories.index;
		thisObj.initTable();
		thisObj.events();
	},
	initTable: function () {
...
events: function () {
	...
	$('#modalEntry').on('shown.bs.modal', function (event) {
			...
			if (dataId) {
				...
				$('#entry-form').attr('action', '/backend/projectcategories/' + dataId);
				...
				// update attribute form
				$('#entry-form').attr('action', '/backend/projectcategories');
...
delete: function (id) {
	...
	$.ketnoimoiAjax({
		url: '/backend/projectcategories/' + id,
		type: 'DELETE',
		success: function (data, textStatus, jqXHR) {
...
$(function () {
	ketnoimoi.projectcategories.index.init();
});