if (typeof ketnoimoi == 'undefined')
	var ketnoimoi = {};
if (typeof ketnoimoi.productcategories == 'undefined')
	ketnoimoi.productcategories = {};

ketnoimoi.productcategories.index = {
	table: null,
	commonControls: [
	{
	...
	},
	{
		'label': 'Đối tượng cha',
		'id': 'parent_id',
		'name': 'ProductCategory[parent_id]',
		'type': 'select',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Hình ảnh',
		'id': 'attachments',
		'name': 'ProductCategory[attachments]',
		'type': 'inputimages',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Xuất bản',
		'id': 'published',
		'name': 'ProductCategory[published]',
		'type': 'checkbox',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	languageControls: [
	{
		'label': 'Tên đối tượng',
		'id': 'name',
		'name': 'ProductCategory[ProductCategoryTranslation][locale][name]',
		'type': 'text',
		'required': true,
	...
	},
	{
		...
		'id': 'summary',
		'name': 'ProductCategory[ProductCategoryTranslation][locale][summary]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		...
		'id': 'meta_description',
		'name': 'ProductCategory[ProductCategoryTranslation][locale][meta_description]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Meta Keywords',
		'id': 'meta_keywords',
		'name': 'ProductCategory[ProductCategoryTranslation][locale][meta_keywords]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	init: function () {
		var thisObj = ketnoimoi.productcategories.index;
		thisObj.initTable();
		thisObj.events();
	},
	initTable: function () {
...
events: function () {
	...
	$('#modalEntry').on('shown.bs.modal', function (event) {
			...
			if (dataId) {
				...
				$('#entry-form').attr('action', '/backend/productcategories/' + dataId);
				...
				// update attribute form
				$('#entry-form').attr('action', '/backend/productcategories');
...
delete: function (id) {
	...
	$.ketnoimoiAjax({
		url: '/backend/productcategories/' + id,
		type: 'DELETE',
		success: function (data, textStatus, jqXHR) {
...
$(function () {
	ketnoimoi.productcategories.index.init();
});