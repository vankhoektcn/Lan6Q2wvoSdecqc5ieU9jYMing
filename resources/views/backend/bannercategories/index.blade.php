...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Danh mục banner</li>
	</ol>
</section>
@endsection
...
<div class="modal fade" id="modalEntry"  tabindex="-1" role="dialog" aria-labelledby="modalEntry" data-backdrop="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="entry-form" class="form-horizontal" action="{{ route('bannercategories.store') }}">
...
<script src="/backend/js/bannercategories/ketnoimoi.bannercategories.index.js" type="text/javascript"></script>
@endsection