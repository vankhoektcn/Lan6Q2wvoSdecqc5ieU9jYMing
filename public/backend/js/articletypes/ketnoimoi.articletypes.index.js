if (typeof ketnoimoi == 'undefined')
	var ketnoimoi = {};
if (typeof ketnoimoi.articletypes == 'undefined')
	ketnoimoi.articletypes = {};

ketnoimoi.articletypes.index = {
	table: null,
	commonControls: [
	{
	...
	languageControls: [
	{
		'label': 'Tên đối tượng',
		'id': 'name',
		'name': 'ArticleType[ArticleTypeTranslation][locale][name]',
		'type': 'text',
		'required': true,
	...
	},
	{
		...
		'id': 'summary',
		'name': 'ArticleType[ArticleTypeTranslation][locale][summary]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		...
		'id': 'meta_description',
		'name': 'ArticleType[ArticleTypeTranslation][locale][meta_description]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Meta Keywords',
		'id': 'meta_keywords',
		'name': 'ArticleType[ArticleTypeTranslation][locale][meta_keywords]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	init: function () {
		var thisObj = ketnoimoi.articletypes.index;
		thisObj.initTable();
		thisObj.events();
	},
	initTable: function () {
...
events: function () {
	...
	$('#modalEntry').on('shown.bs.modal', function (event) {
			...
			if (dataId) {
				...
				$('#entry-form').attr('action', '/backend/articletypes/' + dataId);
				...
				// update attribute form
				$('#entry-form').attr('action', '/backend/articletypes');
...
$(function () {
	ketnoimoi.articletypes.index.init();
});