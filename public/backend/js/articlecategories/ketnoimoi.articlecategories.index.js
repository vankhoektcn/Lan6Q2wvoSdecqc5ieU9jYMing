if (typeof ketnoimoi == 'undefined')
	var ketnoimoi = {};
if (typeof ketnoimoi.articlecategories == 'undefined')
	ketnoimoi.articlecategories = {};

ketnoimoi.articlecategories.index = {
	table: null,
	commonControls: [
	{
	...
	},
	{
		'label': 'Xuất bản',
		'id': 'published',
		'name': 'ArticleCategory[published]',
		'type': 'checkbox',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	languageControls: [
	{
		'label': 'Tên đối tượng',
		'id': 'name',
		'name': 'ArticleCategory[ArticleCategoryTranslation][locale][name]',
		'type': 'text',
		'required': true,
	...
	},
	{
		...
		'id': 'summary',
		'name': 'ArticleCategory[ArticleCategoryTranslation][locale][summary]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		...
		'id': 'meta_description',
		'name': 'ArticleCategory[ArticleCategoryTranslation][locale][meta_description]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Meta Keywords',
		'id': 'meta_keywords',
		'name': 'ArticleCategory[ArticleCategoryTranslation][locale][meta_keywords]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	init: function () {
		var thisObj = ketnoimoi.articlecategories.index;
		thisObj.initTable();
		thisObj.events();
	},
	initTable: function () {
...
events: function () {
	...
	$('#modalEntry').on('shown.bs.modal', function (event) {
			...
			if (dataId) {
				...
				$('#entry-form').attr('action', '/backend/articlecategories/' + dataId);
				...
				// update attribute form
				$('#entry-form').attr('action', '/backend/articlecategories');
...
delete: function (id) {
	...
	$.ketnoimoiAjax({
		url: '/backend/articlecategories/' + id,
		type: 'DELETE',
		success: function (data, textStatus, jqXHR) {
...
$(function () {
	ketnoimoi.articlecategories.index.init();
});