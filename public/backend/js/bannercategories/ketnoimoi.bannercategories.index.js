if (typeof ketnoimoi == 'undefined')
	var ketnoimoi = {};
if (typeof ketnoimoi.bannercategories == 'undefined')
	ketnoimoi.bannercategories = {};

ketnoimoi.bannercategories.index = {
	table: null,
	commonControls: [
	{
	...
	},
	{
		'label': 'Hình ảnh',
		'id': 'attachments',
		'name': 'BannerCategory[attachments]',
		'type': 'inputimages',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Tạo bởi',
		'id': 'created_by',
		'name': 'BannerCategory[created_by]',
		'type': 'static',
		'placeholder': 'Tạo bởi',
		'cssclass': '',
		'value': '',
	...
	},
	{
		'label': 'Cập nhật bởi',
		'id': 'updated_by',
		'name': 'BannerCategory[updated_by]',
		'type': 'static',
	...
	languageControls: [
	{
		'label': 'Tên đối tượng',
		'id': 'name',
		'name': 'BannerCategory[BannerCategoryTranslation][locale][name]',
		'type': 'text',
		'required': true,
	...
	},
	{
		...
		'id': 'summary',
		'name': 'BannerCategory[BannerCategoryTranslation][locale][summary]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		...
		'id': 'meta_description',
		'name': 'BannerCategory[BannerCategoryTranslation][locale][meta_description]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	},
	{
		'label': 'Meta Keywords',
		'id': 'meta_keywords',
		'name': 'BannerCategory[BannerCategoryTranslation][locale][meta_keywords]',
		'type': 'textarea',
		'required': false,
		'placeholder': '',
		'cssclass': '',
	...
	init: function () {
		var thisObj = ketnoimoi.bannercategories.index;
		thisObj.initTable();
		thisObj.events();
	},
	initTable: function () {
...
events: function () {
	...
	$('#modalEntry').on('shown.bs.modal', function (event) {
			...
			if (dataId) {
				...
				$('#entry-form').attr('action', '/backend/bannercategories/' + dataId);
				...
				// update attribute form
				$('#entry-form').attr('action', '/backend/bannercategories');
...
delete: function (id) {
	...
	$.ketnoimoiAjax({
		url: '/backend/bannercategories/' + id,
		type: 'DELETE',
		success: function (data, textStatus, jqXHR) {
...
$(function () {
	ketnoimoi.bannercategories.index.init();
});