	...
	<div class="col-xs-12">
		<div class="box box-success">
			<div class="box-header">
				<button type="button" class="btn btn-sm btn-success btn-flat pull-left" data-toggle="modal" data-target="#modalEntry">Tag mới</button>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
...
<script src="/backend/js/tags/ketnoimoi.tags.index.js" type="text/javascript"></script>
@endsection