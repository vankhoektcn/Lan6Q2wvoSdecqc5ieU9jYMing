	...
	<div class="col-xs-12">
		<div class="box box-success">
			<div class="box-header">
				<button type="button" class="btn btn-sm btn-success btn-flat pull-left" data-toggle="modal" data-target="#modalEntry">Kích thước mới</button>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
...
<div class="modal fade" id="modalEntry"  tabindex="-1" role="dialog" aria-labelledby="modalEntry" data-backdrop="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="entry-form" class="form-horizontal" action="{{ route('productsizes.store') }}">
...
<script src="/backend/js/productsizes/ketnoimoi.productsizes.index.js" type="text/javascript"></script>
@endsection