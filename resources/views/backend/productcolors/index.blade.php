	...
	<div class="col-xs-12">
		<div class="box box-success">
			<div class="box-header">
				<button type="button" class="btn btn-sm btn-success btn-flat pull-left" data-toggle="modal" data-target="#modalEntry">Màu sắc mới</button>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
...
<div class="modal fade" id="modalEntry"  tabindex="-1" role="dialog" aria-labelledby="modalEntry" data-backdrop="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="entry-form" class="form-horizontal" action="{{ route('productcolors.store') }}">
...
<script src="/backend/js/productcolors/ketnoimoi.productcolors.index.js" type="text/javascript"></script>
@endsection