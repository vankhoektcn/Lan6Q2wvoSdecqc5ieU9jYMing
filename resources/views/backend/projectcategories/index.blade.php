...
<div class="modal fade" id="modalEntry"  tabindex="-1" role="dialog" aria-labelledby="modalEntry" data-backdrop="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="entry-form" class="form-horizontal" action="{{ route('projectcategories.store') }}">
...
<script src="/backend/js/projectcategories/ketnoimoi.projectcategories.index.js" type="text/javascript"></script>
@endsection